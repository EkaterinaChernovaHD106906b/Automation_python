...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\user\PycharmProjects\Automation_python\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\user\PycharmProjects\Automation_python\venv\Scripts\deactivate.nu'
